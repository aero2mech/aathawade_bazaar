...
// --- REGIONAL LANGUAGE & STATE RESOLVER ---
enum IndianState { maharashtra, gujarat, karnataka, tamilNadu, general }

IndianState detectState(double lat, double lng) {
  if (lat >= 15.6 && lat <= 22.0 && lng >= 72.6 && lng <= 80.9) {
    return IndianState.maharashtra;
  } else if (lat >= 20.1 && lat <= 24.7 && lng >= 68.1 && lng <= 74.5) {
    return IndianState.gujarat;
  } else if (lat >= 11.5 && lat <= 18.5 && lng >= 74.0 && lng <= 78.6) {
    return IndianState.karnataka;
  } else if (lat >= 8.1 && lat <= 13.5 && lng >= 76.2 && lng <= 80.3) {
    return IndianState.tamilNadu;
  }
  return IndianState.general;
}

String getStateLabel(IndianState state) {
  switch (state) {
    case IndianState.maharashtra:
      return 'Maharashtra (मराठी)';
    case IndianState.gujarat:
      return 'Gujarat (ગુજરાતી)';
    case IndianState.karnataka:
      return 'Karnataka (ಕನ್ನಡ)';
    case IndianState.tamilNadu:
      return 'Tamil Nadu (தமிழ்)';
    case IndianState.general:
      return 'General (English / Hindi)';
  }
}

final List<Map<String, dynamic>> masterVeggieDictionary = [
  {
    'name': 'Fenugreek',
    'icon': '🌿',
    'regional': {
      IndianState.maharashtra: 'मेथी (Methi)',
      IndianState.gujarat: 'મેથી (Methi)',
      IndianState.karnataka: 'ಮೆಂತ್ಯ ಸೊಪ್ಪು (Menthya)',
      IndianState.tamilNadu: 'வெந்தயக்கீரை (Vendhaya Keerai)',
      IndianState.general: 'Fenugreek / Methi',
    },
    'fact': 'Rich in soluble fiber to balance metabolism and blood sugar!'
  },
  {
    'name': 'Bottle Gourd',
    'icon': '🥒',
    'regional': {
      IndianState.maharashtra: 'दुधी भोपळा (Dudhi)',
      IndianState.gujarat: 'દૂધી (Dudhi)',
      IndianState.karnataka: 'ಸೋರೆಕಾಯಿ (Sorekayi)',
      IndianState.tamilNadu: 'சுரைக்காய் (Suraikkai)',
      IndianState.general: 'Bottle Gourd / Lauki',
    },
    'fact': 'Contains over 92% water, excellent for hydration and cooling.'
  },
  {
    'name': 'Bitter Gourd',
    'icon': '🥒',
    'regional': {
      IndianState.maharashtra: 'कारलं (Karle)',
      IndianState.gujarat: 'કારેલા (Karela)',
      IndianState.karnataka: 'ಹಾಗಲಕಾಯಿ (Hagalkayi)',
      IndianState.tamilNadu: 'பாகற்காய் (Pavakkai)',
      IndianState.general: 'Bitter Gourd / Karela',
    },
    'fact': 'Contains polypeptide-p, a natural plant compound supporting healthy sugar levels.'
  },
  {
    'name': 'Brinjal',
    'icon': '🍆',
    'regional': {
      IndianState.maharashtra: 'वांगं (Vangi)',
      IndianState.gujarat: 'રીંગણ (Ringan)',
      IndianState.karnataka: 'ಬದನೆಕಾಯಿ (Badanekayi)',
      IndianState.tamilNadu: 'கத்தரிக்காய் (Kathirikkai)',
      IndianState.general: 'Brinjal / Eggplant',
    },
    'fact': 'Rich in nasunin antioxidant, concentrated in its deep purple skin.'
  },
  {
    'name': 'Okra / Lady Finger',
    'icon': '🫛',
    'regional': {
      IndianState.maharashtra: 'भेंडी (Bhendi)',
      IndianState.gujarat: 'ભીંડા (Bhinda)',
      IndianState.karnataka: 'ಬೆಂಡೆಕಾಯಿ (Bendekayi)',
      IndianState.tamilNadu: 'வெண்டைக்காய் (Vendaikkai)',
      IndianState.general: 'Lady Finger / Bhindi',
    },
    'fact': 'Packed with mucilage fiber that supports smooth digestive health.'
  },
  {
    'name': 'Spinach',
    'icon': '🥬',
    'regional': {
      IndianState.maharashtra: 'पालक (Palak)',
      IndianState.gujarat: 'પાલક (Palak)',
      IndianState.karnataka: 'ಪಾಲಕ್ ಸೊಪ್ಪು (Palak Soppu)',
      IndianState.tamilNadu: 'பசலைக்கீரை (Pasalai Keerai)',
      IndianState.general: 'Spinach / Palak',
    },
    'fact': 'Loaded with iron, folate, and lutein for healthy eyesight.'
  },
  {
    'name': 'Drumstick',
    'icon': '🥢',
    'regional': {
      IndianState.maharashtra: 'शेवग्याची शेंग (Shevga)',
      IndianState.gujarat: 'સરગવો (Saragvo)',
      IndianState.karnataka: 'ನುಗ್ಗೆಕಾಯಿ (Nuggekayi)',
      IndianState.tamilNadu: 'முருங்கைக்காய் (Murungakkai)',
      IndianState.general: 'Moringa / Drumstick',
    },
    'fact': 'Moringa drumsticks carry 7 times more Vitamin C than citrus fruits!'
  },
  {
    'name': 'Cluster Beans',
    'icon': '🌱',
    'regional': {
      IndianState.maharashtra: 'गवार (Gawar)',
      IndianState.gujarat: 'ગુવાર (Guwar)',
      IndianState.karnataka: 'ಗೋರಿಕಾಯಿ (Gorikayi)',
      IndianState.tamilNadu: 'கொத்தவரங்காய் (Kothavarangai)',
      IndianState.general: 'Cluster Beans / Gawar',
    },
    'fact': 'Source of natural plant guar gum, packed with dietary fiber.'
  },
];
...
class _MainNavigationScreenState extends State<MainNavigationScreen> {
  ...
  IndianState _currentState = IndianState.maharashtra;
  ...
  Future<void> _getUserLocation() async {
    try {
      ...
      setState(() {
        ...
        _currentState = detectState(_currentLat, _currentLng);
      });
    } catch (_) {}
  }
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text("🚨 New Bazaar Nearby: $bName", style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
                              Text("📍 $bLocality (${distanceInKm.toStringAsFixed(1)} km away)", style: const TextStyle(fontSize: 12, color: Colors.white70)),
                            ],
                          ),
                        ),
                      ],
  ...
  void _shareApp() async {
    const String shareText =
        ...
        'Find weekly farmers markets near you with live schedules, timings, regional names, and GPS navigation!\n\n'
        '📲 Download here:\n'
        'https://github.com/aero2mech/aathawade_bazaar/releases/latest';

    final Uri sendUri = Uri.parse('https://api.whatsapp.com/send?text=${Uri.encodeComponent(shareText)}');
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            mainAxisSize: MainAxisSize.min,
            children: [
              Text("🌐 Region Detected: ${getStateLabel(_currentState)}", style: const TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: Color(0xFF2E7D32))),
              const SizedBox(height: 8),
              const Text("📍 **Today**: Active markets today with distance calculation.", style: TextStyle(fontSize: 13)),
              const SizedBox(height: 8),
              const Text("🗺️ **Live Map**: Tap pins to navigate, report stock, edit, or review spots.", style: TextStyle(fontSize: 13)),
              const SizedBox(height: 8),
              const Text("⚡ **Live Signals**: Real-time vegetable availability and freshness, tagged in the local state language.", style: TextStyle(fontSize: 13)),
              const SizedBox(height: 8),
              const Text("🎮 **State-Wise Quiz**: AI vegetable trivia adapted to regional names (Marathi, Gujarati, Kannada, Tamil).", style: TextStyle(fontSize: 13)),
            ],
          ),
        ),
        actions: [
  ...
  Widget build(BuildContext context) {
    final screens = [
      const TodayBazaarsScreen(),
      BazaarMapScreen(userState: _currentState),
      const ExploreBazaarsScreen(),
      const AddBazaarScreen(),
      VeggieQuizScreen(userState: _currentState),
    ];
              ...
              children: [
                if (_statusNote != null)
                  Container(
                    ...
                    child: Text(_statusNote!, style: TextStyle(fontSize: 12, color: Colors.amber.shade900)),
                  ),
                Expanded(
                  child: _bazaars.isEmpty
                      ? Center(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text("No active bazaars scheduled today ($dayName).", style: const TextStyle(fontSize: 16, color: Colors.grey)),
                              const SizedBox(height: 8),
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final double distanceKm = (item['distance_meters'] as num) / 1000;
...
// ==========================================
// 2. LIVE MAP (STATE-ADAPTIVE)
// ==========================================
class BazaarMapScreen extends StatefulWidget {
  final IndianState userState;
  const BazaarMapScreen({super.key, required this.userState});
...
class _BazaarMapScreenState extends State<BazaarMapScreen> {
  ...
  void _editBazaarDialog(Map<String, dynamic> bazaar) {
    ...
    final Set<int> selectedDays = schedules.map((s) => (s['day_of_week'] as num).toInt()).toSet();
              ...
              child: Column(
                ...
                children: [
                  TextField(
                    ...
                    decoration: const InputDecoration(labelText: "Bazaar Name", border: OutlineInputBorder(), prefixIcon: Icon(Icons.storefront)),
                  ),
                  const SizedBox(height: 10),
                  TextField(
                    controller: localityController,
                    decoration: const InputDecoration(labelText: "Locality / Area", border: OutlineInputBorder(), prefixIcon: Icon(Icons.location_city)),
                  ),
                  const SizedBox(height: 10),
                  TextField(
                    controller: landmarkController,
                    decoration: const InputDecoration(labelText: "Landmark", border: OutlineInputBorder(), prefixIcon: Icon(Icons.flag_outlined)),
                  ),
                  const SizedBox(height: 14),
                  const Text("⏰ Operating Timings:", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Colors.grey)),
                  const SizedBox(height: 6),
                  Row(
                    children: [
                      Expanded(
                  ...
                  const SizedBox(height: 14),
                  const Text("📅 Select Operating Days:", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Colors.grey)),
                  const SizedBox(height: 6),
                  Wrap(
                    spacing: 6,
                    runSpacing: 4,
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      const Text("📍 Relocate Pin on Map:", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Colors.grey)),
                      IconButton(
                  ...
                  : () async {
                      ...
                      try {
                        ...
                        if (daysToRemove.isNotEmpty) {
                          await supabase.from('bazaar_schedules').delete().eq('bazaar_id', bazaarId).inFilter('day_of_week', daysToRemove);
                        }
                        ...
                        await supabase.from('bazaar_schedules').upsert(upsertList, onConflict: 'bazaar_id,day_of_week');
                        ...
                        if (mounted) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(content: Text("Bazaar spot updated successfully!"), backgroundColor: Color(0xFF2E7D32)),
                          );
                        }
                      } catch (e) {
  ...
  void _showBazaarBottomSheet(Map<String, dynamic> bazaar) {
    final double bLat = (bazaar['latitude'] as num).toDouble();
    final double bLng = (bazaar['longitude'] as num).toDouble();
    final IndianState spotState = detectState(bLat, bLng);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () => _mapController.move(latlong.LatLng(_centerLat, _centerLng), 13),
      ),
      body: _isLoading
          ? const Center(child: CircularProgressIndicator())
          : Stack(
              children: [
                FlutterMap(
                  ...
                  options: MapOptions(initialCenter: latlong.LatLng(_centerLat, _centerLng), initialZoom: 12.0),
                  children: [
                    TileLayer(
                      urlTemplate: 'https://tile.openstreetmap.org/{z}/{x}/{y}.png',
                      userAgentPackageName: 'com.example.aathawade_bazaar',
...
class _BazaarDetailsAndReviewsSheetState extends State<BazaarDetailsAndReviewsSheet> {
  ...
  void initState() {
    super.initState();
    _selectedVeggie = masterVeggieDictionary[0]['regional'][widget.spotState] ?? masterVeggieDictionary[0]['name'];
    _fetchData();
  ...
  Future<void> _fetchData() async {
    try {
      final reviewsRes = await supabase.from('bazaar_reviews').select('*').eq('bazaar_id', widget.bazaarId).order('created_at', ascending: false);
  ...
  @override
  Widget build(BuildContext context) {
    final double avgRating = _reviews.isEmpty ? 0.0 : (_reviews.map((r) => r['rating'] as int).reduce((a, b) => a + b) / _reviews.length);

    final List<String> availableRegionalOptions = masterVeggieDictionary.map((v) {
      final regMap = v['regional'] as Map<IndianState, String>;
      return regMap[widget.spotState] ?? v['name'] as String;
    }).toList();
    ...
    return Padding(
      ...
      child: ListView(
        ...
        children: [
          ...
          Text(
            "🏷️ Regional Dialect: ${getStateLabel(widget.spotState)}",
          ...
          if (_reviews.isNotEmpty) ...[
            ...
            Row(
              children: [
                ...
                Text("${avgRating.toStringAsFixed(1)} / 5.0 (${_reviews.length} reviews)", style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13)),
              ],
            ),
          ],
          const SizedBox(height: 10),
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              onPressed: () async {
                final uri = Uri.parse("https://www.google.com/maps/search/?api=1&query=${widget.bazaar['latitude']},${widget.bazaar['longitude']}");
                if (await canLaunchUrl(uri)) {
                  await launchUrl(uri, mode: LaunchMode.externalApplication);
                }
              },
          ...
          // --- LIVE VEGGIE STOCK & QUALITY FEED (REGIONAL SCRIPT) ---
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              const Text("⚡ Live Stock & Freshness", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
              Container(
          ...
          Card(
            ...
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text("Report Fresh Availability:", style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold)),
                  const SizedBox(height: 8),
                  Row(
                    children: [
                      Expanded(
                        child: DropdownButtonFormField<String>(
                          value: _selectedVeggie,
                          decoration: const InputDecoration(border: OutlineInputBorder(), isDense: true),
                          items: availableRegionalOptions.map((v) => DropdownMenuItem(value: v, child: Text(v, style: const TextStyle(fontSize: 13)))).toList(),
                          onChanged: (val) => setState(() => _selectedVeggie = val!),
                        ),
                      ),
                      const SizedBox(width: 8),
                    ...
                    children: [
                      Expanded(
                        child: TextField(
                          ...
                          decoration: const InputDecoration(hintText: "Price / Stall Note (e.g. ₹20/bunch at stall 2)", border: OutlineInputBorder(), isDense: true),
                        ),
                      ),
                      const SizedBox(width: 8),
                      ElevatedButton(
                      ...
                      Row(
                        children: List.generate(5, (idx) {
                          return GestureDetector(
                            ...
                            child: Icon(idx < _userRating ? Icons.star : Icons.star_border, color: Colors.amber, size: 22),
                          );
                        }),
                      ),
                    ],
...
class _AddBazaarScreenState extends State<AddBazaarScreen> {
  ...
  Future<void> _submitBazaar() async {
    ...
    if (_selectedDays.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Please select at least one operating day.'), backgroundColor: Colors.orange),
      );
      return;
    }
    ...
    try {
      ...
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('📍 Bhaaji Market added for all selected days!'), backgroundColor: Color(0xFF2E7D32)),
      );
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          const Text("📍 Pinpoint Location", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                          Row(
                            children: [
                              TextButton.icon(
                                icon: _isLocating
                      ...
                      const Text("Tap anywhere on the map to place the market pin:", style: TextStyle(fontSize: 12, color: Colors.grey)),
                      const SizedBox(height: 8),
                      AnimatedContainer(
                        duration: const Duration(milliseconds: 250),
                      ...
                      Row(
                        children: [
                          ...
                          const SizedBox(width: 4),
                          Text("Selected: ${_pinnedLat.toStringAsFixed(5)}, ${_pinnedLng.toStringAsFixed(5)}", style: const TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                        ],
                      ),
                    ],
                  ),
              ...
              TextFormField(
                controller: _nameController,
                decoration: const InputDecoration(labelText: "Bazaar Name", hintText: "e.g., Ravet Shetkari Bazaar", border: OutlineInputBorder(), prefixIcon: Icon(Icons.storefront)),
                validator: (v) => v!.isEmpty ? "Enter market name" : null,
              ),
              const SizedBox(height: 12),
              TextFormField(
                controller: _localityController,
                decoration: const InputDecoration(labelText: "Locality / Area", hintText: "e.g., Ravet, Punawale, Wakad", border: OutlineInputBorder(), prefixIcon: Icon(Icons.location_city)),
                validator: (v) => v!.isEmpty ? "Enter locality" : null,
              ),
              const SizedBox(height: 12),
              TextFormField(
                controller: _landmarkController,
                decoration: const InputDecoration(labelText: "Landmark (Optional)", hintText: "e.g., Near D-Mart / Bus Stop", border: OutlineInputBorder(), prefixIcon: Icon(Icons.flag_outlined)),
              ),
              const SizedBox(height: 14),
              ...
              const SizedBox(height: 16),
              const Text("Select Operating Day(s):", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
              const SizedBox(height: 6),
              Wrap(
                spacing: 8,
                runSpacing: 4,
...
// ==========================================
// 5. REGION-ADAPTIVE QUIZ SCREEN
// ==========================================
class VeggieQuizScreen extends StatefulWidget {
  final IndianState userState;
  const VeggieQuizScreen({super.key, required this.userState});
...
class _VeggieQuizScreenState extends State<VeggieQuizScreen> {
  ...
  void initState() {
    super.initState();
    _loadStateAdaptiveQuestions();
  }

  void _loadStateAdaptiveQuestions() {
    setState(() => _isLoadingQuestions = true);

    final List<Map<String, dynamic>> shuffled = List.from(masterVeggieDictionary)..shuffle();

    final List<Map<String, dynamic>> generatedQuestions = shuffled.take(5).map((item) {
      final regMap = item['regional'] as Map<IndianState, String>;
      final String regionalName = regMap[widget.userState] ?? item['name'] as String;
      final String englishName = item['name'] as String;

      final List<String> wrongOptions = masterVeggieDictionary
          .where((v) => v['name'] != englishName)
          .map((v) => (v['regional'] as Map<IndianState, String>)[widget.userState] ?? v['name'] as String)
          .toList()
        ..shuffle();

      final List<String> options = [regionalName, wrongOptions[0], wrongOptions[1], wrongOptions[2]]..shuffle();

      return {
        'question': 'What is this vegetable called in ${getStateLabel(widget.userState).split(' ')[0]}?',
        'english': englishName,
        'icon': item['icon'],
        'options': options,
        'answer': options.indexOf(regionalName),
        'fact': item['fact'],
      };
    }).toList();
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                const Text("Quiz Round Completed!", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
                const SizedBox(height: 8),
                Text(
                ...
                const SizedBox(height: 8),
                Text("Dialect: ${getStateLabel(widget.userState)}", style: const TextStyle(color: Color(0xFF2E7D32), fontWeight: FontWeight.w600)),
                ...
                ElevatedButton.icon(
                  ...
                  onPressed: _loadStateAdaptiveQuestions,
                ),
              ],
            ),
          ),
          ...
          children: [
            Row(
              ...
              children: [
                ...
                Chip(
                  avatar: const Icon(Icons.stars, color: Colors.amber, size: 18),
                  backgroundColor: Colors.green.shade50,
            ...
            const SizedBox(height: 12),
            Center(child: Text(q['icon'], style: const TextStyle(fontSize: 68))),
            const SizedBox(height: 8),
            Text("${q['english']}", textAlign: TextAlign.center, style: const TextStyle(fontSize: 16, color: Colors.grey, fontWeight: FontWeight.bold)),
            const SizedBox(height: 6),
            Text(q['question'], textAlign: TextAlign.center, style: const TextStyle(fontSize: 17, fontWeight: FontWeight.bold)),
            const SizedBox(height: 16),
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    const SizedBox(width: 6),
                    Expanded(
                      child: Text("Did you know? ${q['fact']}", style: const TextStyle(fontSize: 12, color: Color(0xFF1B5E20), fontWeight: FontWeight.w500)),
                    ),
                  ],
                ),
              ),
